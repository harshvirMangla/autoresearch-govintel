...
DEVICE_BATCH_SIZE = 16   # per-device batch size (128 for H100, 16 for M4 Pro MPS)
...
# Reference peak FLOPS for MFU: H100 for CUDA, M4 Pro ~10 TFLOPS for MPS
DEVICE_PEAK_FLOPS = 989.5e12 if device_type == "cuda" else 10.0e12
H100_BF16_PEAK_FLOPS = DEVICE_PEAK_FLOPS  # keep var name for compat
